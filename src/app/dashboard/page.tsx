      ...
      <div className="max-w-6xl mx-auto px-6 py-8 relative z-10">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            {modules.map((moduleItem) => {
              ...
              return (
                <div key={moduleItem.module} className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                  {/* Module Header */}
                  <div 
                    className={`p-6 cursor-pointer hover:bg-gray-50 transition-colors ${isCompleted ? 'bg-green-50' : ''}`}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h3 className={`text-lg font-medium ${isCompleted ? 'text-green-600' : 'text-gray-900'}`}>
                          ...
                          return (
                            <div key={lesson.id} className="relative">
                              <Link
                                ...
                                className="block p-4 bg-white border border-gray-200 rounded-lg hover:border-purple-300 transition-colors group"
                              >
                                <div className="flex items-center space-x-3">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link
              href="/warmup"
              className="bg-white border border-gray-200 rounded-lg p-6 hover:border-purple-300 transition-colors group text-center"
            >
              <div className="text-3xl mb-3">🎵</div>
              <h3 className="font-medium mb-1 text-gray-900 group-hover:text-purple-600 transition-colors">Start Warmup</h3>
              <p className="text-sm text-gray-600">Essential vocal warmup exercises</p>
            </Link>
            ...
            >
              <div className="text-3xl mb-3">📝</div>
              <h3 className="font-medium mb-1 text-gray-900 group-hover:text-purple-600 transition-colors">Assignments</h3>
            ...
            >
              <div className="text-3xl mb-3">💬</div>
              <h3 className="font-medium mb-1 text-gray-900 group-hover:text-purple-600 transition-colors">Community</h3>
            ...
            >
              <div className="text-3xl mb-3">📊</div>
              <h3 className="font-medium mb-1 text-gray-900 group-hover:text-purple-600 transition-colors">Admin</h3>
